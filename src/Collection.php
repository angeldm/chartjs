...
use  Angeldm\ChartJS\Collection\Immutable;
use  Angeldm\ChartJS\MutableInterface;

/**
 * Class Collection
 * @package Halfpastfour\Collection
 */
class Collection extends Immutable implements \Angeldm\ChartJS\Collection\MutableInterface, \IteratorAggregate, ArraySerializableInterface
{
    /**
